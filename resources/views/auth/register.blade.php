        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">   
                    <div class="mx-auto text-center">REGISTRO DE GUIAS EN APP MADGUIDES</div>          
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route('registergu') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="second" class="col-md-4 col-form-label text-md-right">{{ __('Password*') }}</label>
                            <div class="col-md-6">
                                <input id="second" type="password" class="form-control" name="second" >
                            </div>
                        </div>
