    ...
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <div class="details reservation">
                <h3> {{$data['textostraducidos']['nueva_reserva']  }} </h3>
                <p><strong>{{$data['textostraducidos']['cliente']  }}:</strong> {{ $data['namecliente'] ?? '_' }}</p>
                <p><strong>{{$data['textostraducidos']['guia']  }}:</strong> {{ $data['nameguia'] ?? '_' }}</p>
